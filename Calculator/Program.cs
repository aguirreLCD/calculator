...
namespace Calculator
{
    ...
    //     public void MakeSum(double firstNumber, double secondNumber)
    //     {
    //         rounds--;
    //         counter++;
    ...
    //     public void MakeSubtraction(double firstNumber, double secondNumber)
    //     {
    //         rounds--;
    //         counter++;
    ...
    //     public void MakeMultiplication(double firstNumber, double secondNumber)
    //     {
    //         rounds--;
    //         counter++;
    ...
    //     public void MakeDivisionForDecimals(double firstNumber, double secondNumber)
    //     {
            ...
            while (menuSelection != "exit")
            {
                ...
                switch (menuSelection)
                {
                    case "1":
                        ...
                        total = CalculatorLibrary.Calculator.MakeSum(firstNumber, secondNumber, total);
                    ...
                    case "2":
                        ...
                        total = CalculatorLibrary.Calculator.MakeSubtraction(firstNumber, secondNumber, total);
                    ...
                    case "3":
                        ...
                        total = CalculatorLibrary.Calculator.MakeMultiplication(firstNumber, secondNumber, total);
